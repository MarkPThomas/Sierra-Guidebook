...
.\DB-Location-XReferencer\tools\OpenCover.4.6.519\tools\OpenCover.Console.exe -target:"./tools/NUnit.Runners.2.6.4/tools/nunit-console.exe" -targetargs:"/nologo /noshadow ./DB-Location-XReferences.Tests/bin/Debug/DB_Location_XReferences.Tests.dll" -filter:"+[] -[.Tests]" -register:user
